...
Variants:
<Two different forms of this word in phrases>

How to remember: <Interesting information about the word, for example the history of the word, related words from the same language and from other languages>

Synonyms: <A pair of synonyms in the original language with translation in brackets>
